    ...
    self.addListener('raw', function(message) {
        ...
        switch (message.command) {
            ...
            case 'rpl_namreply':
                ...
                //TDDO: investigate - i think it's has something to do with the fact that the user is the same as the sender.
                // crashes only when sending from the same user to the same user.
